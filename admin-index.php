...
<html lang="eng">
  <head>
    ...
    <title>Homepage Admin - JustChat</title>
  ...
  <body>
    ...
    <div class="nav row sticky-top m-auto">
        ...
        <div class="status col-2 d-flex justify-content-end">
            <a href="admin-status.php" title="Status"><i class="fa-solid fa-earth-americas"></i></a>
        </div>
                        ...
                        <?php
                            ...
                            while ($row=mysqli_fetch_assoc($result)) {
                                if($row['username']!="moderator"){
                                    echo "<a href='admin-chat.php?penerima=".$row['username']."' class='list-group-item chat-list bg-body-tertiary'>
