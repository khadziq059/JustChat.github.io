  ...
  <body>
    ...
    <div class="row nav sticky-top m-auto">
      <div class="col-1 d-flex">
        <a href="admin-index.php"><i class="fas fa-arrow-left"></i></a>
      </div>
    ...
    <div class="update container bg-body-tertiary min-vh-100 overflow-hidden">
                  ...
                  <div class="modal-body">
                    <form action="update_username.php" method="POST">
                      <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="newUsername" name="newUsername" disabled placeholder="Admin Cannot Change Username!">
                      </div>
      ...
      <div class="container pengaturan-akun mt-5 card bg-body-tertiary shadow-sm mb-4">
        <div class="col-12">
          ...
          <hr />
          <form action="admin-gantipass.php" method="POST">
            <!-- Button -->
            <button
              type="button"
