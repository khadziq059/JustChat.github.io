...
<html lang="eng">
  <head>
    ...
    <title>My Profile - JustChat</title>
  </head>
  <body>
    <!-- Navbar -->
    ...
    <div class="update container bg-body-tertiary min-vh-100 overflow-hidden">
      ...
      <div class="container pengaturan-akun mt-5 card bg-body-tertiary shadow-sm mb-4">
        <div class="col-12">
          ...
          <a href="hapus_akun.php?pengirim=<?php echo $pengirim; ?>"><button type="button" name="hapusAkun" class="btn btn-light pengaturan w-100">
              Delete Account
            </button></a>
