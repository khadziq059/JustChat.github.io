...
<html lang="eng">
  <head>
    ...
    <title>Status Moderator - JustChat</title>
  </head>
  <body>
    <!-- Navbar whatsapp -->
    <div class="nav row sticky-top m-auto">
        
        <div class="name col-9 d-flex justify-content-start me-3">
    ...
    <div class="status container min-vh-100">
        ...
        <div class="row card shadow-sm mb-2">
            <form action="moderator-status.php" method="POST" enctype="multipart/form-data">
                <div class="row d-flex justify-content-between align-items-start">
                    <div class="kolom1 col-1 d-flex">
                        <a href="moderator-profile.php" title="Profile"><img src="image/<?php echo $gambar; ?>" alt="profile" class="mt-3" id="img"></a>
                    </div>
                    ...
                    if($foto==''){
                        ...
                        <div class='tweet row shadow-sm rounded-4 mb-2'>
                            <div class='tweet-header d-flex mt-3'>
                                ...
                                <div class='delete d-flex justify-content-end me-auto mx-3'>
                                        <a href='moderator-hapus_status.php?id_status=".$id_status."'><i class='fa-solid fa-trash'></i></a>
                                    </div>
                            </div>
