...
<html lang="eng">
  <head>
    ...
    <title>Status Admin - JustChat</title>
  </head>
  <body>
    <!-- Navbar whatsapp -->
    <div class="nav row sticky-top m-auto">
        <div class="profil col-1 me-3">
            <a href="admin-index.php" title="Back"><i class="fas fa-arrow-left"></i></a>
        </div>
    ...
    <div class="status container min-vh-100">
        ...
        <div class="row card shadow-sm mb-2">
            <form action="admin-status.php" method="POST" enctype="multipart/form-data">
                <div class="row d-flex justify-content-between align-items-start">
                    <div class="kolom1 col-1 d-flex">
                        <a href="admin-profile.php" title="Profile"><img src="image/<?php echo $gambar; ?>" alt="profile" class="mt-3" id="img"></a>
                    </div>
                        ...
                        <div class='tweet row shadow-sm rounded-4 mb-2'>
                            <div class='tweet-header d-flex mt-3'>
                                ...
                                <div class='delete d-flex justify-content-end me-auto mx-3'>
                                        <a href='admin-hapus_status.php?id_status=".$id_status."'><i class='fa-solid fa-trash'></i></a>
                                    </div>
                            </div>
